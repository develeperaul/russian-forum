    ...
    <div class="card card_deep tw-grid tw-gap-11 tw-col-span-6">
      ...
      <div class="tw-grid tw-grid-cols-2 tw-gap-5 lg:tw-gap-8.1">
        <div class="tw-grid tw-gap-5 lg:tw-gap-8.1">
          <div
            class="tw-text-red tw-text-base lg:tw-text-t14 tw-pb-2 lg:tw-pb-3 tw-border-b-[0.106rem] tw-border-[#C2D2E5]/25"
          >
            Бюджет РФ
          </div>
          <div class="tw-flex tw-gap-4 lg:tw-gap-5.2 tw-font-ibm">
            ...
            <div
              class="tw-text-t00 lg:tw-text-t13 -tw-tracking-12 lg:-tw-tracking-21 tw-leading-[120%]"
            >
              млн ₽
            </div>
          </div>
